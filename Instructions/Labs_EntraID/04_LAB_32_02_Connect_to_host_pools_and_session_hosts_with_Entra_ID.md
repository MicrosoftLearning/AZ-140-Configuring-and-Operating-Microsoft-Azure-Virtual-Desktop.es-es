...
- Para validar la funcionalidad de los hosts de sesión de Azure Virtual Desktop unidos a Microsoft Entra, conéctate a ellos desde un cliente de Windows que no esté unido a Microsoft Entra ni registrado.
