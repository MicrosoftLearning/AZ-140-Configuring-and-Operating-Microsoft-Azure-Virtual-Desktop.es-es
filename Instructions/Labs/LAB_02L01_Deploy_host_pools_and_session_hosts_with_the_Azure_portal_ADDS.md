...
# <a name="lab---deploy-host-pools-and-session-hosts-by-using-the-azure-portal-ad-ds"></a>Laboratorio: Implementación de grupos de hosts y hosts de sesión mediante Azure Portal (AD DS)
...
### <a name="exercise-1-implement-an-azure-virtual-desktop-environment-in-an-ad-ds-domain"></a>Ejercicio 1: Implementar un entorno de Azure Virtual Desktop en un dominio de Azure AD DS.
...
1. En la pestaña **Máquinas virtuales** de la hoja **Crear un grupo de hosts**, especifique la siguiente configuración y seleccione **Siguiente: Área de trabajo >** (deje las opciones restantes con sus valores predeterminados)
   ...
   |Imagen|**Windows 10 Enterprise para sesiones múltiples, versión 20H2 + Aplicaciones de Microsoft 365**|
...
#### <a name="task-3-manage-the-azure-virtual-desktop-host-pool-session-hosts"></a>Tarea 3: Administración de los hosts de sesión del grupo de hosts de Azure Virtual Desktop
...
#### <a name="task-4-configure-azure-virtual-desktop-application-groups"></a>Tarea 4: Configuración de grupos de aplicaciones de Azure Virtual Desktop
...
1. En la hoja **Seleccionar usuarios o grupos de usuarios de Azure AD**, seleccione **az140-wvd-pooled** y haga clic en **Seleccionar**.
...
1. En la hoja **Seleccionar usuarios o grupos de usuarios de Azure AD**, seleccione **az140-wvd-remote-app** y haga clic en **Seleccionar**.
...
1. De nuevo en la pestaña **Aplicaciones** de la hoja **Crear un grupo de aplicaciones**, seleccione **Siguiente: Asignaciones >** .
1. En la pestaña **Asignaciones** de la hoja **Crear un grupo de aplicaciones**, seleccione **+ Agregar usuarios o grupos de usuarios de Azure AD**.
1. En la hoja **Seleccionar usuarios o grupos de usuarios de Azure AD**, seleccione **az140-wvd-remote-app** y **az140-wvd-admins** y haga clic en **Seleccionar**.
1. De nuevo en la pestaña **Asignaciones** de la hoja **Crear un grupo de aplicaciones**, seleccione **Siguiente: Workspace >** (Siguiente: Área de trabajo).
1. En la pestaña **Área de trabajo** de la hoja **Crear un área de trabajo**, especifique la siguiente configuración y seleccione **Revisar y crear**:
...
#### <a name="task-5-configure-azure-virtual-desktop-workspaces"></a>Tarea 5: Configuración de áreas de trabajo de Azure Virtual Desktop
