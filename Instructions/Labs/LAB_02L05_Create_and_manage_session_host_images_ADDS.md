...
Debe crear y administrar imágenes de host de Azure Virtual Desktop en un entorno de Microsoft Entra DS.
...
### Ejercicio 1: Creación y administración de imágenes de host de sesión
...
1. En la sesión de Bastion a **az140-25-vm0**, inicie Microsoft Edge, vaya a la [página de descarga de FSLogix](https://aka.ms/fslogix_download), descargue los archivos binarios de instalación comprimidos de FSLogix en la carpeta **C:\\Allfiles\\Labs\\02** y, desde Explorador de archivos, extraiga la subcarpeta **x64** en la misma carpeta.
1. En la sesión de Bastion a **az140-25-vm0**, cambie a la ventana **Administrador: Windows PowerShell ISE** y, en la consola de **Administrador: Windows PowerShell ISE**, ejecute lo siguiente para realizar la instalación por máquina de OneDrive:
